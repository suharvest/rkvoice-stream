...
导出在 x86 Linux(本项目用 wsl2-local)跑;推理产物传 radxa 编译。独立 uv 环境见 [`models/rk1828/export/`](../models/rk1828/export/)。

### 4.1 环境(uv)
见 [`models/rk1828/export/pyproject.toml`](../models/rk1828/export/pyproject.toml)。关键约束:
